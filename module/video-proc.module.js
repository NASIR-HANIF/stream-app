const videoProcessing = (key) => {
    ...
    const params =  {
          ...
          "OutputGroups": [
            {
              ...
              "OutputGroupSettings": {
                ...
                "CmafGroupSettings": {
                  ...
                  "Destination": "s3://stream-storage-app-pk/stream/"+folder
                }
              }
            }
          ],
          ...
          "Inputs": [
            {
              ...
              "FileInput": "s3://stream-storage-app-pk/"+key
            }
          ],
          "FollowSource": 1
        },
        ...
        "Role": "arn:aws:iam::237594464081:role/service-role/MediaConvert_Default_Role"
      }
